...
## 1.3 数据仓库--Hive（简单了解即可）	

### 		1.3.1 数据仓库基本概念

​	    数据仓库，英文名称为Data Warehouse，可简写为DW或DWH。数据仓库，是为企业所有级别的决策制定过程，提供所有类型数据支持的战略集合。它是单个数据存储，出于分析性报告和决策支持目的而创建。 为需要业务智能的企业，提供指导业务流程改进、监视时间、成本、质量以及控制。

### 		1.3.2 数据处理分类：OLAP与OLTP
...
​		Thrift服务允许客户端使用Java、C++、Ruby等多种语言，通过编程的方式远程访问Hive
...
![1563262098436](E:/study/笔记/hive/images/本地数据库模式安装.png)

​	2、使用远程数据库mysql作为元数据存储

![1563262117701](E:/study/笔记/hive/images/远程数据库模式安装.png))
...
官网  https://cwiki.apache.org/confluence/display/Hive/LanguageManual+DDL#LanguageManualDDL-BucketedSortedTables
...
## 11.3 基于SQL标准的hiveserver2授权模式的限制
...
​		Hive的SQL语句在执行之前需要将SQL语句转换成MapReduce任务，因此需要了解具体的转换过程，可以在SQL语句中输入如下命令查看具体的执行计划。（小白慎用）
...
![](E:/study/笔记/hive/images/parquet文件格式.png)
...
官网  https://cwiki.apache.org/confluence/display/Hive/HiveServer2+Clients
